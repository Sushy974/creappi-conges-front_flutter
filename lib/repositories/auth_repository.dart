...
class LocalAuthRepository implements AuthRepository {
  ...
  Future<Utilisateur> recupererUtilisateurConnecte({
    ...
    try {
      const requestUrl =
          'https://creappi-conges-api.onrender.com/api/v1/auth/me';
      final uri = Uri.parse(requestUrl);

      // Utiliser http.get pour une meilleure compatibilité CORS
...
class RenderAuthRepository implements AuthRepository {
  final ApiService _apiService = ApiService();
  ...
  Future<AuthResponse> initialiserAdmin({
    ...
    try {
      ...
      const requestUrl =
          'https://creappi-conges-api.onrender.com/api/v1/auth/initialize';
      final uri = Uri.parse(requestUrl);
  ...
  Future<AuthResponse> connexion({
    ...
    try {
      ...
      // Essayer différentes URLs
      const requestUrl =
          'https://creappi-conges-api.onrender.com/api/v1/auth/connexion';
      //const requestUrl = 'https://httpbin.org/anything';
      final uri = Uri.parse(requestUrl);

      // Utiliser http.post pour une meilleure compatibilité CORS
  ...
  Future<AuthResponse> inscrireEmploye({
    ...
    try {
      ...
      const requestUrl =
          'https://creappi-conges-api.onrender.com/api/v1/auth/inscription-employe';
      final uri = Uri.parse(requestUrl);
